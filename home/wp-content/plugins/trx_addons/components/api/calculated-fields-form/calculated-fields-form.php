...
if ( !function_exists( 'trx_addons_calculated_fields_form_need_load_scripts' ) ) {
	function trx_addons_calculated_fields_form_need_load_scripts( $force ) {
		return trx_addons_exists_calculated_fields_form()
				&& (
...
if ( !function_exists( 'trx_addons_calculated_fields_form_load_scripts_front' ) ) {
	...
	function trx_addons_calculated_fields_form_load_scripts_front( $force = false ) {
		static $loaded = false;
		if ( ! $loaded && trx_addons_calculated_fields_form_need_load_scripts( $force ) ) {
			$loaded = true;
