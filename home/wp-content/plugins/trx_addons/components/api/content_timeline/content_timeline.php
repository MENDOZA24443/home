...
if ( !function_exists( 'trx_addons_content_timeline_need_load_scripts' ) ) {
	function trx_addons_content_timeline_need_load_scripts( $force ) {
		return trx_addons_exists_content_timeline()
				&& (
...
if ( !function_exists( 'trx_addons_content_timeline_load_scripts_front' ) ) {
	...
	function trx_addons_content_timeline_load_scripts_front( $force = false ) {
		static $loaded = false;
		if ( ! $loaded && trx_addons_content_timeline_need_load_scripts( $force ) ) {
			$loaded = true;
