...
if ( !function_exists( 'trx_addons_mailchimp_need_load_scripts' ) ) {
	function trx_addons_mailchimp_need_load_scripts( $force ) {
		return trx_addons_exists_mailchimp()
				&& (
...
if ( !function_exists( 'trx_addons_mailchimp_load_scripts_front' ) ) {
	...
	function trx_addons_mailchimp_load_scripts_front( $force = false ) {
		static $loaded = false;
		if ( ! $loaded && trx_addons_mailchimp_need_load_scripts( $force ) ) {
			$loaded = true;
...
if ( !function_exists( 'trx_addons_mailchimp_merge_scripts' ) ) {
	...
	function trx_addons_mailchimp_merge_scripts($list) {
		if ( trx_addons_exists_mailchimp() && trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
