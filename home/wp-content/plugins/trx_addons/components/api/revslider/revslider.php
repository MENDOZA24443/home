...
if ( !function_exists( 'trx_addons_revslider_need_load_scripts' ) ) {
	function trx_addons_revslider_need_load_scripts( $force ) {
...
if ( !function_exists( 'trx_addons_revslider_load_scripts_front' ) ) {
	...
	function trx_addons_revslider_load_scripts_front( $force = false ) {
		static $loaded = false;
		if ( ! $loaded && trx_addons_revslider_need_load_scripts( $force ) ) {
			$loaded = true;
