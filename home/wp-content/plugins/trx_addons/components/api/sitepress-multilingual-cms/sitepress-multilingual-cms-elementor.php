...
// Load base class definition for shortcodes with items (field type REPEATER)
...
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-module-with-items.php';

// Load class definitions for each shortcode with items (field type REPEATER)
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-action.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-button.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-googlemap.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-icons.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-osmap.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-price.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-skills.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-socials.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-supertitle.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-sc-yandexmap.php';

// Load class definitions for each widget with items (field type REPEATER)
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-widget-audio.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-widget-custom-links.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-widget-slider.php';
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-widget-video-list.php';

// Load class definitions for third-party shortcodes/widgets with items (field type REPEATER)
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'sitepress-multilingual-cms/ate/class-wpml-elementor-trx-widget-woocommerce-search.php';
