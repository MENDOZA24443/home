...
if ( !function_exists( 'trx_addons_booked_need_load_scripts' ) ) {
	function trx_addons_booked_need_load_scripts( $force ) {
		return trx_addons_exists_booked()
				&& (
...
if ( !function_exists( 'trx_addons_booked_load_scripts_front' ) ) {
	...
	function trx_addons_booked_load_scripts_front( $force = false ) {
		static $loaded = false;
		if ( ! $loaded && trx_addons_booked_need_load_scripts( $force ) ) {
			$loaded = true;
