...
//					.attr('data-settings', JSON.stringify(params))
	...
	function trx_addons_elementor_add_bg_text_in_row( row ) {
		...
		if ( data['bg_text'] ) {
			...
			if ( marquee_speed > 0 && cid === '' ) {
				...
				setTimeout( function() {
					trx_addons_elementor_marquee_bg_text( marquee_wrap, marquee_dir, marquee_speed, marquee_time, true );
	...
	// Marqueue bg text
	function trx_addons_elementor_marquee_bg_text( marquee_wrap, marquee_dir, marquee_speed, marquee_time, start ) {
		...
		if ( elements.eq(0).hasClass( 'trx_addons_showed_on_scroll' ) ) {
					...
					marquee_time - marquee_time * 0.8 * marquee_speed / 10,
					{
						...
						onComplete: function() {
							if ( idx == elements.length - 1 ) {
								...
								setTimeout( function() {
									trx_addons_elementor_marquee_bg_text( marquee_wrap, marquee_dir, marquee_speed, marquee_time, false );
								}, 1);
							}
						}
					}
			...
			setTimeout( function() {
				trx_addons_elementor_marquee_bg_text( marquee_wrap, marquee_dir, marquee_speed, marquee_time, start );
