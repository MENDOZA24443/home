...
class trx_addons_widget_video_list extends TRX_Addons_Widget {
	...
	function update( $new_instance, $instance ) {
		...
		$instance['controller_autoplay'] = isset( $new_instance['controller_autoplay'] ) ? 1 : 0;
		$instance['controller_link'] = isset( $new_instance['controller_link'] ) ? 1 : 0;
...
if ( !function_exists( 'trx_addons_widget_video_list_merge_styles' ) ) {
	...
	function trx_addons_widget_video_list_merge_styles($list) {
		if ( trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$list[] = TRX_ADDONS_PLUGIN_WIDGETS . 'video_list/video_list.css';
		}
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_widget_video_list_merge_styles_responsive' ) ) {
	...
	function trx_addons_widget_video_list_merge_styles_responsive($list) {
		if ( trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$list[] = TRX_ADDONS_PLUGIN_WIDGETS . 'video_list/video_list.responsive.css';
		}
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_widget_video_list_add_editor_style' ) ) {
	add_filter( 'trx_addons_filter_add_editor_style', 'trx_addons_widget_video_list_add_editor_style', TRX_ADDONS_ENQUEUE_SCRIPTS_PRIORITY );
	function trx_addons_widget_video_list_add_editor_style( $styles ) {
		if ( ! trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$styles[] = trx_addons_get_file_url( TRX_ADDONS_PLUGIN_WIDGETS . 'video_list/video_list.css' );
		}
		return $styles;
	}
}
...
if ( !function_exists( 'trx_addons_widget_video_list_add_editor_style_responsive' ) ) {
	add_filter( 'trx_addons_filter_add_editor_style', 'trx_addons_widget_video_list_add_editor_style_responsive', TRX_ADDONS_ENQUEUE_RESPONSIVE_PRIORITY );
	function trx_addons_widget_video_list_add_editor_style_responsive( $styles ) {
		if ( ! trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$styles[] = trx_addons_get_file_url( TRX_ADDONS_PLUGIN_WIDGETS . 'video_list/video_list.responsive.css' );
		}
		return $styles;
	}
}
