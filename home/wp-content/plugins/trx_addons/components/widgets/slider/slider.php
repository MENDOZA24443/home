...
class trx_addons_widget_slider extends TRX_Addons_Widget {
	...
	function widget( $args, $instance ) {
		...
		if (in_array($engine, array('swiper', 'elastistack'))) {
			...
			$large = isset($instance['large']) && $instance['large'] > 0 ? 'yes' : 'no';
			$noswipe = isset($instance['noswipe']) && $instance['noswipe'] > 0 ? 'yes' : 'no';
			$controls = isset($instance['controls']) && $instance['controls'] > 0 ? 'yes' : 'no';
			...
			$pagination = isset($instance['pagination']) && $instance['pagination'] > 0 ? 'yes' : 'no';
			...
			$controller = isset($instance['controller']) && $instance['controller'] > 0 ? 'yes' : 'no';
	...
	function update( $new_instance, $instance ) {
		...
		$instance['mouse_wheel'] = isset( $new_instance['mouse_wheel'] ) ? 1 : 0;
		$instance['autoplay'] = isset( $new_instance['autoplay'] ) ? 1 : 0;
		$instance['free_mode'] = isset( $new_instance['free_mode'] ) ? 1 : 0;
		$instance['noswipe'] = isset( $new_instance['noswipe'] ) ? 1 : 0;
		$instance['noresize'] = isset( $new_instance['noresize'] ) ? 1 : 0;
	...
	function form( $instance ) {
		...
		$this->show_field(array('name' => 'controller_per_view',
								...
								'dependency' => array(
									'controller' => array( 1 ),
									'controller_effect' => array( 'slide', 'coverflow' )
								),
								'type' => 'text'));
