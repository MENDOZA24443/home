...
if (!function_exists('trx_addons_cpt_cars_add_roles_and_caps')) {
	...
	function trx_addons_cpt_cars_add_roles_and_caps() {
		...
		// Add caps to roles
		trx_addons_add_capabilities( array( 'administrator', 'editor' ), array( 'car', 'cars_agent' ) );
		trx_addons_add_capabilities( array( 'author', 'trx_addons_cars_agent' ), 'car', array( '_others' ) );
...
if ( ! function_exists( 'trx_addons_cpt_cars_allow_admin_access' ) ) {
	add_filter( 'trx_addons_filter_allow_admin_access', 'trx_addons_cpt_cars_allow_admin_access', 10, 2 );
	function trx_addons_cpt_cars_allow_admin_access( $allow, $roles ) {
...
if ( !function_exists( 'trx_addons_cpt_cars_add_editor_style' ) ) {
	add_filter( 'trx_addons_filter_add_editor_style', 'trx_addons_cpt_cars_add_editor_style', TRX_ADDONS_ENQUEUE_SCRIPTS_PRIORITY );
	function trx_addons_cpt_cars_add_editor_style( $styles ) {
		if ( ! trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$styles[] = trx_addons_get_file_url( TRX_ADDONS_PLUGIN_CPT . 'cars/cars.css' );
		}
		return $styles;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_cars_add_editor_style_responsive' ) ) {
	add_filter( 'trx_addons_filter_add_editor_style', 'trx_addons_cpt_cars_add_editor_style_responsive', TRX_ADDONS_ENQUEUE_RESPONSIVE_PRIORITY );
	function trx_addons_cpt_cars_add_editor_style_responsive( $styles ) {
		if ( ! trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$styles[] = trx_addons_get_file_url( TRX_ADDONS_PLUGIN_CPT . 'cars/cars.responsive.css' );
		}
		return $styles;
	}
}
