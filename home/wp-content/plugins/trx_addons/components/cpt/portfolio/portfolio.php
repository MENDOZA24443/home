...
if ( !function_exists( 'trx_addons_cpt_portfolio_merge_scripts' ) ) {
	...
	function trx_addons_cpt_portfolio_merge_scripts($list) {
		if ( trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			...
			//$list[] = TRX_ADDONS_PLUGIN_CPT . 'portfolio/gallery/gallery.js';
		}
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_portfolio_add_editor_style' ) ) {
	add_filter( 'trx_addons_filter_add_editor_style', 'trx_addons_cpt_portfolio_add_editor_style', TRX_ADDONS_ENQUEUE_SCRIPTS_PRIORITY );
	function trx_addons_cpt_portfolio_add_editor_style( $styles ) {
		if ( ! trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$styles[] = trx_addons_get_file_url( TRX_ADDONS_PLUGIN_CPT . 'portfolio/portfolio.css' );
		}
		return $styles;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_portfolio_add_editor_style_responsive' ) ) {
	add_filter( 'trx_addons_filter_add_editor_style', 'trx_addons_cpt_portfolio_add_editor_style_responsive', TRX_ADDONS_ENQUEUE_RESPONSIVE_PRIORITY );
	function trx_addons_cpt_portfolio_add_editor_style_responsive( $styles ) {
		if ( ! trx_addons_is_off( trx_addons_get_option( 'optimize_css_and_js_loading' ) ) ) {
			$styles[] = trx_addons_get_file_url( TRX_ADDONS_PLUGIN_CPT . 'portfolio/portfolio.responsive.css' );
		}
		return $styles;
	}
}
