...
if ( ! function_exists( 'inestio_customizer_get_css' ) ) {

	function inestio_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts        = inestio_customizer_add_theme_fonts( $fonts );
			$rez          = array();
...
CSS;
			$rez          = apply_filters( 'inestio_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = inestio_customizer_add_theme_vars( $vars );
...
CSS;
			$rez         = apply_filters( 'inestio_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars'] = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( inestio_get_sorted_schemes() ) : array( $scheme );
			if ( count( $schemes ) > 0 ) {
				$rez = array();
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = inestio_get_scheme_colors( $s );
					}
...
form.wp-block-search .wp-block-search__button:hover:after {
...
.post_item_404.post_item_none_search button.search_submit.trx_addons_icon-search:hover {
...
.sc_button_transparent.sc_button:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image) {
    color: {$colors['text_dark']};
}
.sc_button_transparent.sc_button:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
    color: {$colors['extra_bg_color']};
}
...
.scheme_self.menu_mobile .menu_mobile_nav_area li a:hover,
.scheme_self.menu_mobile .menu_mobile_nav_area li.current-menu-item.current_page_item a {
	color: {$colors['alter_dark']};
}
...
.top_panel_default .sc_layouts_title_breadcrumbs .breadcrumbs a {
	color: {$colors['text_dark']};
}
.top_panel_default.with_bg_image .top_panel_title .sc_layouts_title_caption,
.top_panel_default.with_bg_image .sc_layouts_title_breadcrumbs .breadcrumbs,
.top_panel_default.with_bg_image .sc_layouts_title_breadcrumbs .breadcrumbs a {
	color: {$colors['extra_dark']};
}
...
.inestio_tabs .inestio_tabs_titles li a:hover, .inestio_tabs .inestio_tabs_titles li a:focus {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.inestio_tabs .inestio_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.scheme_self.sidebar .inestio_tabs .inestio_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
...
.scheme_self.sidebar .inestio_tabs .inestio_tabs_titles li a:hover, .scheme_self.sidebar .inestio_tabs .inestio_tabs_titles li a:focus {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.scheme_self.sidebar .inestio_tabs .inestio_tabs_titles li.ui-state-active a {
...
.sc_blogger_classic-masonry .post_layout_classic-masonry {
  background-color: {$colors['bg_color']};
}
...
.post_layout_portfolio_2 .mejs-controls .mejs-tim,
...
.post_layout_portfolio_2.trx_addons_audio_player.with_cover .audio_author,
.post_layout_portfolio_2.format-audio .post_featured.with_thumb .post_audio_author,
.post_layout_portfolio_3.trx_addons_audio_player.with_cover .audio_author,
.post_layout_portfolio_3.format-audio .post_featured.with_thumb .post_audio_author,
.post_layout_portfolio_4.trx_addons_audio_player.with_cover .audio_author,
.post_layout_portfolio_4.format-audio .post_featured.with_thumb .post_audio_author {
	color: {$colors['inverse_text']};	
}
...
.wp-widget-media_audio .mejs-container .mejs-controls {
	border-color: {$colors['alter_bd_color']};
	background-color: {$colors['alter_bg_color']};
}
...
.post_item.post_layout_excerpt .post_category .post_categories a:hover {
	background-color: {$colors['alter_link3']};
	color: {$colors['extra_dark']};
}

.post_item_single .post_tags_single a,
.post_item_single .post_footer  .post_meta_item.post_categories a,
.wp-block-tag-cloud a,
...
.wp-block-tag-cloud,
.post_item_single .post_footer  .post_meta_item.post_categories {
	color: {$colors['alter_dark']};
}

.post_item_single .post_tags_single a:hover,
.post_item_single .post_footer .post_meta_item.post_categories a:hover {
    color: {$colors['inverse_link']} !important;
    background-color: {$colors['text_link']};
}
.post_item_single .post_tags_single a:hover
...
.author_bio .author_links > a:hover {
	color: {$colors['extra_bg_color']};
}
...
.comments_form label+ .sc_form_field_wrap:before,
.comment-respond label+ .sc_form_field_wrap:before {
	color: {$colors['text_dark']};
}
...
input[type="email"]:hover,sc_button_hover_style_dark
...
.select_container select:hover  /* style not applicable */
{ 
	border-color: {$colors['input_bd_hover']}; 
}
/* Comments */
...
.comments_list_wrap .comment_info .comment_author a,
.comments_list_wrap .comment_info .comment_author .comment_posted {
	color: {$colors['alter_light']};
}
...
/* Style 1 */
.post_header_wrap_style_style-1 .post_featured_bg + .post_header .post_meta_other .post_meta_item,
.post_header_wrap_style_style-1 .post_featured_bg + .post_header .post_title,
.post_header_wrap_style_style-1 .post_featured_bg + .post_header .post_meta_item.post_author .post_author_name {
	color: {$colors['extra_dark']};	
}
.post_header_wrap_style_style-1 .post_featured_bg + .post_header .post_meta_item.post_author:hover  .post_author_name {
	color: {$colors['extra_bg_color']};	
}

/* Style 2 */
.scheme_self.single_style_style-2 .post_header_wrap_in_content {
	border-color: {$colors['bd_color']};
}
...
/* wp-widget-nav_menu  */
footer .widget.wp-widget-nav_menu ul li a:hover{
	color: {$colors['extra_bg_color']};	
}
...
CSS;
					...
					$rez            = apply_filters(
						'inestio_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'inestio_filter_prepare_css', $css_str, $remove_spaces );
	}
}
