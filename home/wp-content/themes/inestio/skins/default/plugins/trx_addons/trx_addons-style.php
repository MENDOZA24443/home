...
if ( ! function_exists( 'inestio_trx_addons_add_theme_vars' ) ) {
	add_filter( 'inestio_filter_add_theme_vars', 'inestio_trx_addons_add_theme_vars', 10, 2 );
	function inestio_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'inestio_trx_addons_get_css' ) ) {
	add_filter( 'inestio_filter_get_css', 'inestio_trx_addons_get_css', 10, 2 );
	function inestio_trx_addons_get_css( $css, $args ) {
...
.sc_courses_default .sc_team .sc_team_item_thumb .sc_team_item_socials .social_item .social_icon .trx_addons_hover_links a,
...
.widget_popular_posts .trx_addons_tabs .trx_addons_tabs_titles li {
	{$fonts['h5_font-family']}
}
.widget_popular_posts a.post_info_date {
    {$fonts['h5_font-family']}
}
/* Skills (Counters) */
.sc_skills_counter .sc_skills_item_title { 
...
.sc_blogger_portfolio .post_meta_item.post_categories{
	{$fonts['p_font-family']}
}

/* sc_icons */
.sc_icons .sc_item_title {
	{$fonts['p_font-family']}
}

/* widget_services */ 
.widget_services .sc_services_title {
	{$fonts['h5_font-size']}
}
...
ul[class*="trx_addons_list"] > li a:hover,
ol li a:hover{
...
ul[class*="trx_addons_list"] > li:hover:before,
ol li:hover::before{
...
.trx_addons_hover_mask {
	background-color: {$colors['text_hover3_06']};
}
...
.slider_elastistack.slider_controls_side .slider_controls_wrap > a {
	color: {$colors['text_dark']}!important;
}
.slider_elastistack.slider_controls_side .slider_controls_wrap > a:hover {
...
.sc_widget_slider .slider_container.slider_controls_side .slider_controls_wrap > a:hover,
.sc_widget_slider .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['extra_bg_color']};
}

.sc_widget_slider .slider_outer_controls_outside .slider_controls_wrap > a,
...
.sidebar_inner .scheme_self.widget.widget_contacts {
	background-color: {$colors['alter_bg_color']};	
}
.sidebar_inner .scheme_self.widget_contacts .widget_title {
	color: {$colors['alter_dark']};
}
.scheme_self.widget_contacts .contacts_info {
	color: {$colors['alter_dark']};
}
.scheme_self.widget_contacts .contacts_info span {
	border-color: {$colors['alter_bd_color']};
}
.scheme_self.widget_contacts .contacts_info span:not(:last-child) {
	border-color: {$colors['bd_color']};
}
.scheme_self.footer_wrap .widget_contacts .contacts_info span:not(:last-child) {
	border-color: {$colors['bd_color']};
}
.scheme_blue.widget_contacts .contacts_info span:not(:last-child) {
	border-color: {$colors['bd_color_05']};
}
.scheme_self.widget_contacts .contacts_info span:before,
.scheme_self.widget_contacts .contacts_info > div > a:before,
.scheme_self.widget_contacts .contacts_info > a:before {
	color: {$colors['alter_dark']};
}
...
.scheme_self.widget_contacts .contacts_info span a,
.scheme_self.widget_contacts .contacts_info > div > a,
.scheme_self.widget_contacts .contacts_info > a {
	color: {$colors['text_dark']};
}
.scheme_self.widget_contacts .contacts_info span a:hover,
.scheme_self.widget_contacts .contacts_info > div > a:hover,
.scheme_self.widget_contacts .contacts_info > a:hover {
	color: {$colors['extra_bg_color']};
}
.scheme_self.scheme_blue.widget_contacts .contacts_info span a:hover,
.scheme_self.scheme_blue.widget_contacts .contacts_info > div > a:hover,
.scheme_self.scheme_blue.widget_contacts .contacts_info > a:hover {
	color: {$colors['alter_text']};
}
...
.sc_item_featured [class*="post_info_"] {
	color:{$colors['extra_text']};	
	background-color:{$colors['text_hover3_07']};	
}
...
.sc_action_item .sc_action_item_link.sc_button {
	border-color:{$colors['extra_text']}!important;
}
.sc_action_item .sc_action_item_link.sc_button:hover {
	background-color: {$colors['inverse_bg_color']}!important;
}
.sc_action_simple .sc_action_item_simple.with_image:after {
  background: {$colors['text_hover3_15']};
}
.sc_action_simple .sc_action_item_simple.with_image:hover:after {
  background: {$colors['text_hover3_05']};
}
...
.sc_blogger_item_default.sc_blogger_item_on_plate .sc_blogger_item_body:hover,
.sc_blogger_item_list.sc_blogger_item_on_plate .sc_blogger_item_body:hover,
.sc_blogger_item_wide.sc_blogger_item_on_plate:hover {
	background-color: {$colors['alter_bg_hover']};
}

.sc_blogger_item_default.sc_blogger_item_on_plate .sc_blogger_item_body:hover .post_meta_categories .post_categories,
.sc_blogger_item_list.sc_blogger_item_on_plate .sc_blogger_item_body:hover .post_meta_categories .post_categories,
.sc_blogger_item_wide.sc_blogger_item_on_plate:hover .post_meta_categories .post_categories{
	background-color: {$colors['alter_link3']};
}

.sc_blogger_item_default.sc_blogger_item_on_plate .sc_blogger_item_body:hover .sc_blogger_item_excerpt:after,
.sc_blogger_item_list.sc_blogger_item_on_plate .sc_blogger_item_body:hover .sc_blogger_item_excerpt:after,
.sc_blogger_item_wide.sc_blogger_item_on_plate:hover .sc_blogger_item_excerpt:after{
	background-image: -webkit-gradient(linear,left top,left bottom,from({$colors['alter_bg_hover_00']}),to({$colors['alter_bg_hover']}));
    background-image: -webkit-linear-gradient(top,{$colors['alter_bg_hover_00']},{$colors['alter_bg_hover']});
    background-image: -o-linear-gradient(top,{$colors['alter_bg_hover_00']},{$colors['alter_bg_hover']});
    background-image: linear-gradient(180deg,{$colors['alter_bg_hover_00']},{$colors['alter_bg_hover']});
}
...
.sc_blogger_item_on_plate .sc_blogger_item_content a.sc_button_simple:hover:before,
.sc_blogger_item_on_plate .sc_blogger_item_content a.sc_button_simple:hover:after {
...
.sc_blogger_item_default.sc_blogger_item_on_plate .sc_blogger_item_excerpt:after {
	background-image: -webkit-gradient(linear,left top,left bottom,from({$colors['alter_bg_color_00']}),to({$colors['bg_color']}));
	background-image: -webkit-linear-gradient(top,{$colors['alter_bg_color_00']},{$colors['bg_color']});
	background-image: -o-linear-gradient(top,{$colors['alter_bg_color_00']},{$colors['bg_color']});
	background-image: linear-gradient(180deg,{$colors['alter_bg_color_00']},{$colors['bg_color']});	
}
...
.sc_blogger_default .sc_item_descr {
	color: {$colors['text']};
}

.sc_blogger_default .post_meta_categories .post_categories{
	color: {$colors['extra_dark']};
	background-color: {$colors['extra_bg_color']};
}

.sc_blogger_default .post_meta_categories .post_categories:hover{
	color: {$colors['extra_dark']};
	background-color: {$colors['alter_link3']};
}

.sc_blogger_classic .post_meta:before {
	background-color: {$colors['text_dark']};
}

.sc_blogger_classic-masonry .post_meta .post_categories,
.sc_blogger_classic-masonry .post_meta .post_categories a{
	color: {$colors['alter_light']};
}
.sc_blogger_classic-masonry .post_meta .post_categories:hover,
.sc_blogger_classic-masonry .post_meta .post_categories a:hover {
	color: {$colors['extra_bg_hover']};
}

.sc_blogger_classic .post_header:before,
.sc_blogger_list  .sc_blogger_item_content:before {
	background-color: {$colors['alter_dark']};
}
.sc_blogger_default_over_centered .sc_item_featured [class*="post_info_"] .entry-title + .post_meta .post_meta_item,
.sc_blogger_default_over_centered .sc_item_featured [class*="post_info_"] .entry-title + .post_meta .post_meta_item a,
.sc_blogger_default_over_centered .sc_item_featured .sc_blogger_item_excerpt,
.sc_blogger_default_over_centered .sc_blogger_item_button.sc_item_button a {
	color: {$colors['extra_dark_08']};
}

.sc_blogger_default_over_centered .sc_item_featured .post_info_mc .post_meta:not(.post_meta_categories) a:hover {
	color: {$colors['extra_bg_color']};
}
...
/* responsive menu */
a.sf-with-ul.icon-ellipsis-vert:before {
	color: {$colors['alter_link2']};
}
...
/* Icons */
.sc_icons_default .sc_icons_item:hover .sc_icons_icon,
.sc_icons_modern .sc_icons_item:hover .sc_icons_icon,
.sc_icons_onplate .sc_icons_item:hover .sc_icons_icon {
	color: {$colors['inverse_bd_color']};
}
.sc_icons_modern .sc_icons_item:after {
...
.sc_icons_onplate .sc_icons_item {
	background-color: {$colors['bg_color']};
}

.sc_icons_withborder .trx_addons_columns_wrap > [class*="trx_addons_column-"]:not(:last-of-type) .sc_icons_item {
  border-color: {$colors['inverse_bd_color_02']};
}
...
.portfolio_page_related.sc_portfolio_default .post_featured.hover_info .post_meta_item.post_categories a{
	color: {$colors['alter_link']};
	background-color: transparent;
}

.post_featured.hover_fade .post_info .post_categories a{
	color: {$colors['extra_text']};
}
...
.portfolio_page_related.sc_portfolio_default .post_featured.hover_info .post_title a:hover {
	color: {$colors['extra_bg_color']};
}
...
.sc_layouts_panel a:hover {
	color:{$colors['extra_bg_color']};
}

.sc_layouts_panel .sc_widget_contacts .contacts_info a {
	color:{$colors['alter_dark']};
}

.sc_layouts_panel .sc_widget_contacts .contacts_info a:hover {
	color:{$colors['extra_bg_color']};
}
...
/* Services */
.sc_services_chess .sc_services_item_number {
	color: {$colors['alter_bg_hover']};
}
...
.sc_services_chess .sc_services_item .sc_services_item_title:hover a {
	color: {$colors['extra_bg_color']};
}
...
.sc_services_light .sc_item_title_style_default {
	color: {$colors['alter_dark']};
}
...
.sc_services_light .sc_item_wrap:hover {
...
/*  widget_popular_posts */
.sc_widget_popular_posts .widget_popular_posts{
	background-color: {$colors['alter_bg_color']};
}
.widget_popular_posts .trx_addons_tabs .trx_addons_tabs_titles li a {
	background-color: {$colors['extra_dark']};
	color: {$colors['inverse_bd_hover']};
}
.widget_popular_posts .trx_addons_tabs .trx_addons_tabs_titles li a:hover {
	background-color: {$colors['extra_hover']};
	color: {$colors['extra_dark']};
}
.widget_popular_posts .trx_addons_tabs .trx_addons_tabs_titles li.ui-state-active a {
	background-color: {$colors['alter_link2']};  
	color: {$colors['extra_dark']};
}
.widget_popular_posts .trx_addons_tabs .trx_addons_tabs_titles li.ui-state-active a:hover {
	background-color: {$colors['alter_hover2']};  
	color: {$colors['extra_dark']};
}

/* widget_services */
.widget_services .sc_services_item_title a{
	color: {$colors['alter_text']};
}
.widget_services .sc_services_item_title a{
	color: {$colors['alter_text']};
...
.widget_services .sc_services_item_title a:hover{
	color: {$colors['extra_bg_color']};
}
...
.widget_services .sc_services_item_title:hover:before {
	color: {$colors['text_dark']};  
}

/* sc title */
.sc_layouts_row_type_compact .sc_layouts_title .post_meta_item.post_author .post_author_name {
	color: {$colors['extra_text']};
}

.sc_layouts_row_type_compact .sc_layouts_title .post_meta_item.post_categories a {
	background-color: {$colors['extra_bg_color']};
}
.sc_layouts_row_type_compact .sc_layouts_title .post_meta_item.post_categories a:hover {
	background-color: {$colors['alter_link3']};
	color: {$colors['extra_dark']}!important;
}

.sc_layouts_row_type_compact .sc_layouts_title .sc_layouts_title_meta .post_meta .post_meta_item:hover,
.sc_layouts_row_type_compact .sc_layouts_title .sc_layouts_title_meta .post_meta .post_meta_item span:hover {
	color: {$colors['extra_bg_color']};
}

/* search_wrap */
.search_wrap.search_style_expand .scheme_dark input[type="text"]{
}
