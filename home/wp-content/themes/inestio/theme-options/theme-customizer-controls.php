...
// 'info' field
//--------------------------------------------------------------------
class Inestio_Customize_Info_Control extends WP_Customize_Control {
	public $type = 'info';
...
// 'hidden' field
//--------------------------------------------------------------------
class Inestio_Customize_Hidden_Control extends WP_Customize_Control {
	public $type = 'hidden';
	...
	public function render_content() {
		...
		if ( 'last_option' == $this->id && inestio_storage_get( 'need_footer_scripts', false ) ) {
			inestio_storage_set( 'need_footer_scripts', false );
...
// 'button' field
//--------------------------------------------------------------------
class Inestio_Customize_Button_Control extends WP_Customize_Control {
	public $type = 'button';
...
// 'switch' field
//--------------------------------------------------------------------
class Inestio_Customize_Switch_Control extends WP_Customize_Control {
	public $type = 'switch';
	...
	public function render_content() {
		...
		<div class="customize-control-wrap">
			...
			?>
			<label class="customize-control-field-wrap inestio_options_item_switch">
				<input type="hidden"
					<?php
					$this->link();
					if ( ! empty( $this->input_attrs['var_name'] ) ) {
...
// 'icon' field
//--------------------------------------------------------------------
class Inestio_Customize_Icon_Control extends WP_Customize_Control {
	public $type = 'icon';
...
// 'checklist' field
//--------------------------------------------------------------------
class Inestio_Customize_Checklist_Control extends WP_Customize_Control {
...
// 'choice' field
//--------------------------------------------------------------------
class Inestio_Customize_Choice_Control extends WP_Customize_Control {
	public $type = 'choice';
...
// 'scheme_editor' field
//--------------------------------------------------------------------
class Inestio_Customize_Scheme_Editor_Control extends WP_Customize_Control {
			...
			/>
				...
				inestio_show_layout(
					inestio_show_custom_field(
						...
						$this->input_attrs,
						inestio_unserialize( $this->input_attrs['value'] )
					)
				);
				?>
			</span>
...
// 'text_editor' field
//--------------------------------------------------------------------
class Inestio_Customize_Text_Editor_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		inestio_storage_set( 'need_footer_scripts', true );
	}
}
...
// 'range' field
//--------------------------------------------------------------------
class Inestio_Customize_Range_Control extends WP_Customize_Control {
	public $type = 'range';
	...
	public function render_content() {
		...
		<div class="customize-control-wrap">
			...
			<span class="customize-control-field-wrap"><input type="<?php echo ! $show_value ? 'hidden' : 'text'; ?>" 
				...
				$this->link();
				if ( $show_value ) {
					echo ' class="inestio_range_slider_value"';
				}
				if ( ! empty( $this->input_attrs['var_name'] ) ) {
					echo ' data-var_name="' . esc_attr( $this->input_attrs['var_name'] ) . '"';
				}
