...
WordPress version: required at least 4.5, tested up to 5.4
...
For the full realization of their capabilities, the theme requires a satellite plugin 'AxiomThemes Addons'.
...
Please install and activate it before starting to use the theme Inestio.
...
Theme documentation is available on http://inestio.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Inestio is Fontello.
